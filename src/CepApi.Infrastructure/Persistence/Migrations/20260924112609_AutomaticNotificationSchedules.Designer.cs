...
namespace CepApi.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260924112609_AutomaticNotificationSchedules")]
    partial class AutomaticNotificationSchedules
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CepApi.Domain.AutomaticNotificationExecution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("CreatedNotificationCount")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ScheduleId", "LocalDate")
                        .IsUnique();

                    b.HasIndex("Status", "LeaseExpiresAt");

                    b.ToTable("automatic_notification_executions", null, t =>
                        {
                            t.HasCheckConstraint("ck_automatic_notification_executions_attempts", "\"Attempts\" > 0");

                            t.HasCheckConstraint("ck_automatic_notification_executions_notification_count", "\"CreatedNotificationCount\" >= 0");
                        });
                });

            modelBuilder.Entity("CepApi.Domain.AutomaticNotificationSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OrganizationId", "LocalTime", "TimeZoneId")
                        .IsUnique();

                    b.ToTable("automatic_notification_schedules", null, t =>
                        {
                            t.HasCheckConstraint("ck_automatic_notification_schedules_minute_precision", "date_part('second', \"LocalTime\") = 0");
                        });
                });
            ...
            modelBuilder.Entity("CepApi.Domain.TimeControlNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("time_control_notifications", (string)null);
                });
            ...
            modelBuilder.Entity("CepApi.Domain.AutomaticNotificationExecution", b =>
                {
                    ...
                    b.HasOne("CepApi.Domain.AutomaticNotificationSchedule", "Schedule")
                        .WithMany()
            ...
            modelBuilder.Entity("CepApi.Domain.TimeControlNotification", b =>
                {
                    b.HasOne("CepApi.Domain.AutomaticNotificationExecution", "Execution")
                        .WithMany()
