        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanUseRevit = table.Column<bool>(type: "boolean", nullable: false),
                    CanUseZwcad = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_product_accesses", x => new { x.UserId, x.Product });
                    table.ForeignKey(
                        name: "FK_product_accesses_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_invitations_Email_RevokedAt_AcceptedAt",
                table: "invitations",
                columns: new[] { "Email", "RevokedAt", "AcceptedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_password_resets_UserId_UsedAt",
